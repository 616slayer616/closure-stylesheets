...
public final class Property {
    ...
    static {
        ...
        List<Builder> recognizedProperties = ImmutableList.of(
                ...
                builder("moz-column-break-inside"),
                ...
                builder("-moz-flex-grow"),
                builder("-moz-flex-flow"),
                builder("-moz-flex-shrink"),
